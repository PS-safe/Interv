...
type IWorkspaceService interface {
	...
	Create(title string, isCoding *bool, isVideo *bool, startDate time.Time, endDate time.Time, portalId *uint, reqScreen *bool, reqMicrophone *bool, reqCamera *bool) (workspace *domains.Workspace, err error)
