...
type IWorkspaceService interface {
	...
	Create(title string, startDate time.Time, endDate time.Time, isVideo *bool, isCoding *bool, codingTime uint, reqScreen *bool, reqMicrophone *bool, reqCamera *bool, portalId uint) (workspace *domains.Workspace, err error)
