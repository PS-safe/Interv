...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/question.deleteVideoQuestionById": {
            "post": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/question.getVideoQuestionById/{id}": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/question.getVideoQuestionWorkspaceIdId/{id}": {
            "get": {
                "consumes": [
                    "application/json"
                ],
